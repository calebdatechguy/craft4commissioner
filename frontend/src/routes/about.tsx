      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6 text-lg text-slate-700 leading-relaxed">
            ...
            <p>
              Having called Barrow County home for over <strong>22 years</strong>, Eric has deep roots in our community. He has seen it grow and change, and he is committed to ensuring that growth benefits everyone.
            </p>
            <p>
